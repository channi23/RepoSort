      ...
      <div className="relative max-w-6xl mx-auto">
        <div className="flex flex-col items-center justify-center mb-16">
          <div className="relative z-10 bg-[#E6E6E6] rounded-xl shadow-lg px-16 py-4 md:px-24 md:py-6">
            <h1 className="text-7xl md:text-9xl font-bold tracking-[1.31px] text-[#0B0A0C] font-epilogue text-center" style={{textShadow:"0px 4px 4px rgba(182, 19, 19, 0.25)"}}>RepoSort</h1>
          </div>        
