...
export default function TeamCard({name,role,color,socialsColor,quoteColor,quote,twitterUrl,instagramUrl,}: TeamCardProps) {
  return (
    <div className="w-[380px] h-[280px] flex-shrink-0 flex flex-col overflow-y-auto snap-y snap-mandatory scroll-smooth rounded-lg shadow-lg" style={{ scrollbarWidth: 'none', msOverflowStyle: 'none' }}>
